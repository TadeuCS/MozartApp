...
//    protected EntityManagerFactory emf=Persistence.createEntityManagerFactory("MozartAppPU");
//    protected EntityManager em=emf.createEntityManager();
    ...
    private void start() {
        if (getConexao(prop.ler("ip"), prop.ler("banco"), prop.ler("usuario"), prop.ler("senha")) != null) {
            emf = Persistence.createEntityManagerFactory("MozartAppPU", getParametros());
